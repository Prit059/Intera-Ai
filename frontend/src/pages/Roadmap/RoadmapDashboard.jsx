                ...
                >
                  ...
                  <div className='mt-auto pt-4'>
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 py-2 bg-blue-600/20 border border-blue-700 hover:bg-blue-500 rounded-lg text-white transition-colors"
                    >
