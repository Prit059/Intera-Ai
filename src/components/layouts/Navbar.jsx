...
function Navbar() {
  ...
  return (
    <nav className={`sticky top-0 z-50 backdrop-blur-lg border-b border-gray-700 bg-black`}>
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          
          {/* Logo */}
          <Link to="/" className="items-start text-left">
            <h2 className="text-2xl bg-gradient-to-r from-violet-100 to-orange-400 bg-clip-text text-transparent font-bold">
              Intera.AI
            </h2>
          </Link>
                  ...
                  <div key={item.path} className="relative group">
                    <Link
                      ...
                      className={`relative flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 cursor-pointer ${
                        isActive(item)
                          ? "bg-orange-600/10 border border-orange-400/50 text-white"
